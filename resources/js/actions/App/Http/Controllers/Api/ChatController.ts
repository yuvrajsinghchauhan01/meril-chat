...
* @see app/Http/Controllers/Api/ChatController.php:1296
...
* @see app/Http/Controllers/Api/ChatController.php:1326
...
* @see app/Http/Controllers/Api/ChatController.php:1379
* @route '/api/conversations/{id}'
*/
...
* @see app/Http/Controllers/Api/ChatController.php:1352
* @route '/api/conversations/{id}'
*/
...
* @see app/Http/Controllers/Api/ChatController.php:1419
...
* @see app/Http/Controllers/Api/ChatController.php:1470
* @route '/api/messages/{id}'
*/
...
* @see app/Http/Controllers/Api/ChatController.php:1509
...
* @see app/Http/Controllers/Api/ChatController.php:1609
