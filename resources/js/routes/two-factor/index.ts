 ...
 * @route '/api/user/two-factor-authentication'
 */
 ...
 * @route '/api/user/confirmed-two-factor-authentication'
 */
 ...
 * @route '/api/user/two-factor-qr-code'
 */
 ...
 * @route '/api/user/two-factor-secret-key'
 */
 ...
 * @route '/api/user/two-factor-recovery-codes'
 */
